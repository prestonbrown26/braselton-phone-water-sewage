...
EMAIL_FROM_AGENT = env("EMAIL_FROM_AGENT", default=EMAIL_FROM_ADDRESS)
EMAIL_FROM_APP = env("EMAIL_FROM_APP", default=EMAIL_FROM_ADDRESS)
EMAIL_STUB_MODE = env("EMAIL_STUB_MODE")
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default=EMAIL_FROM_AGENT)
SERVER_EMAIL = env("SERVER_EMAIL", default=EMAIL_FROM_AGENT)
